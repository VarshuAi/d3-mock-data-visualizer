...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/d3-mock-data-visualizer.git
   cd d3-mock-data-visualizer
   ```
...
[![Repo](https://img.shields.io/badge/d3-mock-data-visualizer-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/d3-mock-data-visualizer)
